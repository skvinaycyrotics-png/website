    ...
    <div className="flex flex-col">
      <section className="relative w-full pb-24 bg-primary/5">
        ...
        <div className="relative z-10">
          ...
          <div className="absolute -bottom-24 md:-bottom-48 lg:-bottom-64 left-1/2 -translate-x-1/2 w-[90%] md:w-[80%]">
      ...
      <section
        id="stats"
        className="bg-background pt-40 md:pt-64 lg:pt-80 pb-12 sm:pt-48 lg:pb-20"
      >

...
export default function AutomotiveEngineeringPage() {
  const service = SERVICES.find(s => s.slug === 'automotive-engineering');
          ...
          <aside className="lg:col-span-1">
            <Card className="sticky top-24 shadow-lg">
              <CardHeader className="bg-muted/50">
                ...
                <CardDescription>
                  We leverage powerful tools for automotive engineering.
                </CardDescription>
              </CardHeader>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 text-center">
          ...
          <p className="mt-4 text-lg max-w-2xl mx-auto">
            Our automotive engineering experts are ready to help you accelerate your development and manufacturing goals.
          </p>
          <div className="mt-8">
            <Button asChild size="lg" variant="secondary">
              <Link href="/contact">
                Contact an Automotive Specialist <ArrowRight />
              </Link>
            </Button>
          </div>
        </div>

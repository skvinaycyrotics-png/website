...
export const metadata = {
  ...
  description: 'Driving the future of mobility with advanced automotive engineering, simulation, and autonomous systems.',
};

export default function AutomotiveEngineeringPage() {
  const serviceData = SERVICES.find(s => s.slug === 'automotive-engineering');
  ...
  return (
    <>
      ...
      <BottomCTA 
        ...
        primaryButtonText="Contact an Automotive Specialist"
      />
    </>
  );
}
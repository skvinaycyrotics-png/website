      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 text-center">
          ...
          <p className="mt-4 text-lg max-w-2xl mx-auto">
            Our energy specialists are ready to design a renewable energy solution that cuts costs and powers your sustainability goals.
          </p>
          <div className="mt-8">
            <Button asChild size="lg" variant="secondary">
              <Link href="/contact">
                Contact an Energy Specialist <ArrowRight />
              </Link>
            </Button>
          </div>
        </div>
